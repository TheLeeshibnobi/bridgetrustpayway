...
def checkout():
    ...
    # Handle GET requests (direct access to checkout page)
    return render_template('checkout.html')
    ...
    if request.method == 'POST':
        try:
            ...
            try:
                ...
                # Convert to ngwee (multiply by 100 since 1 Kwacha = 100 ngwee)
...
def check_payment_status(payment_id):
    ...
    try:
        ...
        pay_manager = Pay()
        payment_successful = pay_manager.check_payment_status(payment_id)
